...
python forest_UAV_U_Net_pytorch.py cypress 150 24 256 msk_crop4Corner_5120_3584_Size0512_lap0256_rotate_flipMirror

python forest_UAV_U_Net_pytorch.py cedar 150 24 256 org_crop4Corner_5120_3584_Size0512_lap0256_rotate_flipMirror
python forest_UAV_U_Net_pytorch.py cedar 150 24 256 org_crop4Corner_5376_3584_Size0256_lap0000_rotate_flipMirror